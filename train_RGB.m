...
ff_train1 = fopen('image4tensorflow/train/train_rgb_fullbody.txt','w');
ff_val1 = fopen('image4tensorflow/train/val_rgb_fullbody.txt','w');
ff_train2 = fopen('image4tensorflow/train/train_rgb_full.txt','w');
ff_val2 = fopen('image4tensorflow/train/val_rgb_full.txt','w');
...
1      obj_origin = VideoReader(['DATA/IsoGD_phase_1/IsoGD_phase_1/',file(1:21)]);
      ...
      outImageNamef = fullfile(Norm4S_dir1,num2str(str2num(file(45:end))-1,'%03d'),file(11:17));
      outImageNamer = fullfile(Norm4S_dir2,num2str(str2num(file(45:end))-1,'%03d'),file(11:17));
      if ~exist(fullfile(Norm4S_dir1,num2str(str2num(file(45:end))-1,'%03d'),file(11:17)))
          mkdir(fullfile(Norm4S_dir1,num2str(str2num(file(45:end))-1,'%03d'),file(11:17)));
      end
      if ~exist(fullfile(Norm4S_dir2,num2str(str2num(file(45:end))-1,'%03d'),file(11:17)))
          mkdir(fullfile(Norm4S_dir2,num2str(str2num(file(45:end))-1,'%03d'),file(11:17)));
      end
      for t = 1:numFrames_origin
        ...
        fprintf(ff_train2,[outImageNamef,' ',num2str(numFrames_origin),' ',num2str(str2num(file(45:end))-1),'\n']);
        if mod(str2num(file(13:17)),3)==0
            fprintf(ff_val1,[fullfile(Norm4S_dir1,file(11:17)),' ',num2str(numFrames_origin),' ',num2str(str2num(file(45:end))-1),'\n']);
            fprintf(ff_val2,[fullfile(Norm4S_dir2,file(11:17)),' ',num2str(numFrames_origin),' ',num2str(str2num(file(45:end))-1),'\n']);
        end
