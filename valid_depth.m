clear,clc
parent_dir = 'image4tensorflow/valid/';
...
ff_train1 = fopen('image4tensorflow/valid/valid_depth_fullbody.txt','w');
ff_train2 = fopen('image4tensorflow/valid/valid_depth_full.txt','w');
...
while feof(fpn) ~= 1                %用于判断文件指针p在其所指的文件中的位置，如果到文件末，函数返回1，否则返回0  
      ...
      detectionLabel = fopen(['DATA/DetectionLabel4Depth4valid/',file(29:31),'/Label_',file(33:39),'.txt']);
      ...
      outImageNamef = fullfile(Norm4S_dir1,file(29:31),file(33:39));
      outImageNamer = fullfile(Norm4S_dir2,file(29:31),file(33:39));
      if ~exist(fullfile(Norm4S_dir1,file(29:31),file(33:39)))
          mkdir(fullfile(Norm4S_dir1,file(29:31),file(33:39)));
      end
      if ~exist(fullfile(Norm4S_dir2,file(29:31),file(33:39)))
          mkdir(fullfile(Norm4S_dir2,file(29:31),file(33:39)));
      end
      for t = 1:numFrames_origin
        ...
        fprintf(ff_train1,[outImageNamef,' ',num2str(numFrames_origin),' ',num2str(0),'\n']);
        fprintf(ff_train2,[outImageNamer,' ',num2str(numFrames_origin),' ',num2str(0),'\n']);
