...
for n in xrange(num4subfolders1):
    filenames = os.listdir(Depth4valid1+subfolders1[n])
    for m in xrange(len(filenames)):
        rightname = Depth4valid1+subfolders1[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders2):
    filenames = os.listdir(RGB4valid1+subfolders2[n])
    for m in xrange(len(filenames)):
        rightname = RGB4valid1+subfolders2[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders3):
    filenames = os.listdir(Depth4valid2+subfolders3[n])
    for m in xrange(len(filenames)):
        rightname = Depth4valid2+subfolders3[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders4):
    filenames = os.listdir(RGB4valid2+subfolders4[n])
    for m in xrange(len(filenames)):
        rightname = RGB4valid2+subfolders4[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders5):
    filenames = os.listdir(Depth4valid3+subfolders5[n])
    for m in xrange(len(filenames)):
        rightname = Depth4valid3+subfolders5[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders6):
    filenames = os.listdir(RGB4valid3+subfolders6[n])
    for m in xrange(len(filenames)):
        rightname = RGB4valid3+subfolders6[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders7):
    filenames = os.listdir(Depth4valid4+subfolders7[n])
    for m in xrange(len(filenames)):
        rightname = Depth4valid4+subfolders7[n]+'/'+filenames[m]
...
for n in xrange(num4subfolders8):
    filenames = os.listdir(RGB4valid4+subfolders8[n])
    for m in xrange(len(filenames)):
        rightname = RGB4valid4+subfolders8[n]+'/'+filenames[m]
...
file_object1 = open('test_prediction_ava.txt','w')
...
for IMAGE_FILE1, IMAGE_FILE2, IMAGE_FILE3, IMAGE_FILE4,IMAGE_FILE5, IMAGE_FILE6, IMAGE_FILE7, IMAGE_FILE8 in zip(TestFileNames1,TestFileNames2,TestFileNames3,TestFileNames4,TestFileNames5,TestFileNames6,TestFileNames7,TestFileNames8):
    ...
    str0 = IMAGE_FILE1[-15:]
    str1 = 'test/'+str0[0:4]+'K'+str0[5:11]+'.avi'
    str2 = 'test/'+str0[0:4]+'M'+str0[5:11]+'.avi'
    strall = str2+' '+str1+' ' + str(tem1)+'\n'
